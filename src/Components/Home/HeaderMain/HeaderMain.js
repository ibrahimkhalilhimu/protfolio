...
const HeaderMain = () => {
    return (
        <div  className="pt-5 mt-5">
            ...
            <br/>
           <a href='./https://drive.google.com/file/d/1QcCZkBHSVL88IUEJD03nofQ5dxbRPyBA/view?usp=sharing'download> <Button variant="outline-success" >Download Resume</Button></a>
            </Col>
